...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// This is an example of how to include a plugin bundled with a theme.
			...
			array(
				'name'      => 'WordPress SEO by Yoast', //نام افزونه در مخزن
				'slug'      => 'wordpress-seo', // نام فولدری که بعد از نصب این افزونه ایجاد می شود
				'required'  => true, // مقدار ترو یعنی این افزونه لازم است و مقدار فالس یعنی این افزونه پیشنهادیست
			),
