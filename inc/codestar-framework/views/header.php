...
<div class="csf-welcome csf-welcome-wrap">
  ...
  <h1>به افزونه پنل تنظیمات ساز codestar Framework خوش آمدید. ورژن<?php echo esc_attr( CSF::$version ); ?></h1>

  <p class="csf-about-text">یک ابزار ساده و حرفه ای برای ساخت پنل تنظیمات محصولات وردپرسی</p>
