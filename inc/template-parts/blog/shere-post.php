...
<div class="telegram-instagrem-box">
            <div class="row">
                <div class="col-md-6">

                <a href="<?php echo $options['opt-text-post-blog-tel-link'] ?>" class="darkeble aw-blog-single-social-box  aw-blog-single-social-box-telegram" target="_blank" rel="nofollow external noopener">
                    <div class="aw-blog-single-social-box-icon">
                    ...
                    <div class="aw-blog-single-social-box-text">
                        در
                        <b>تلگرام</b>
                        <br>
                        <?php echo $options['opt-text-post-blog-tel-ins'] ?>
                    </div>
                </a>
                </div>
                <div class="col-md-6">
                <a href="<?php echo $options['opt-text-post-blog-ins-link'] ?>" class="darkeble aw-blog-single-social-box  aw-blog-single-social-box-instagram" data-wpel-link="external" target="_blank" rel="nofollow external noopener">
                    <div class="aw-blog-single-social-box-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
